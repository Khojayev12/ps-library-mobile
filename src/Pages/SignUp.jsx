        ...
        <Box component="div" className="register-page" >
            <LanguageContext.Consumer>
                {lang => (
                    ...
                    <input className="input-name" type="text" placeholder={lang.enterName} style={{top:"248px"}} onSelect={()=>{setSelectedInput("name")}} />
                    ...
                    <input className="input-name" type="email" placeholder={lang.enterEmail} style={{top:"364px"}} onFocus={()=>{setSelectedInput("email")}} />
