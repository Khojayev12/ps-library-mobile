        ...
        <LanguageContext.Consumer>
            {lang => (
                <Box component="div" className="intro-page" >
                    ...
                    <Link to="/register" style={{color:"unset", textDecoration:"none"}} > <RegBtn> {lang.register} </RegBtn> </Link>
                    <Link to="/login" style={{color:"unset", textDecoration:"none"}} ><Kirish> {lang.enter} </Kirish></Link>
                </Box>
            )}
        </LanguageContext.Consumer>
    )
