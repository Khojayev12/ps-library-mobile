...
export default function Menu(){
    ...
    return(
        <LanguageContext.Consumer >
            {lang => (<>
            <Box component={"div"} sx={{width:"100%", position:"fixed"}} >
            ...
            <Box component={"div"} className={isMenuOpen?"menu-left active-m" : "menu-left not-active"} >
                ...
                <MenuButton className="menu-btn" sx={{marginTop:"200px"}} >
                ...
                <Link to="/orders" className="Mylink" > <MenuButton className="menu-btn">
            ...
            <div className={isLMenuOpen? "LMenu L-open" : "LMenu L-closed"} >
                <div className="Lmenu-line"> <Link to="/profile" className="Mylink" >
                    <img src={Person} alt="" className="Lmenu-img"/>
                    <span className="Lmenu-span">Profil</span></Link>
                    <hr className="ML-hr" style={{height:"0px"}} /> 
                </div>
                <div className="Lmenu-line">
                    <img src={Sozlama} alt="" className="Lmenu-img"/>
                    <span className="Lmenu-span">Sozlamalar</span>
                    <hr className="ML-hr" />
                </div>
                <Link to="/start" className="Mylink" > <div className="Lmenu-line">
